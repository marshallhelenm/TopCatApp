...
#n1 events
n1e1 = Event.create(title: "A coyote!", description: "What is that doing in this neighborhood???", hazard_rating: 3, lives_score: - 1, hunger_score: 0, scraggliness_score: + 1, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2012/04/30/10/56/animal-44780_1280.png")

n1e2 = Event.create(title: "Mud puddle...", description: "...Jump in it? Hell yeah!", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: + 1, cred_score: 0, posh_event: false, img_url: "https://image.freepik.com/free-vector/mud-pond-garden_1308-10762.jpg")

n1e3 = Event.create(title: "Broken bag of kibble!", description: "Dog food is still food and you're hungry.", hazard_rating: 0, lives_score: 0, hunger_score: - 1, scraggliness_score: 0, cred_score: 0, posh_event: false, img_url: "https://www.flaticon.com/premium-icon/icons/svg/2002/2002535.svg")

n1c1 = Event.create(title: "A bright orange stray cat catches you unawares!", description: "They get the better of you, and you slink away in shame.", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: 0, cred_score: - 1, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2017/03/16/19/20/vector-2150014_1280.png")
...
n2e2 = Event.create(title: "An excited toddler approaches you.", description: "They pet you with sticky hands. Gross...", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: + 1, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2014/10/28/20/29/baby-507132_1280.png")

n2e3 = Event.create(title: "You find an open composting bin!", description: "Free fish head! Tasty.", hazard_rating: 0, lives_score: 0, hunger_score: - 1, scraggliness_score: 0, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2019/07/09/13/04/rotten-4326830_1280.png")

n2c1 = Event.create(title: "A fat, odd smelling stray cat catches you unawares!", description: "They get the better of you, and you slink away in shame.", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: 0, cred_score: - 1, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2012/05/07/13/47/cat-48506__480.png")
...
n3e1 = Event.create(title: "Oncoming car!", description: "The car squashes your tail as it swerves to miss you. Ouch!", hazard_rating: 3, lives_score: - 1, hunger_score: - 1, scraggliness_score: 0, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2014/04/03/00/41/race-car-309123_1280.png")

n3e2 = Event.create(title: "Moving along the rooftops, you slip!", description: "You land in an open dumpster. You're safe, but what is that horrible smell?", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: + 1, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2012/04/16/13/57/trash-36103__480.png")

n3e3 = Event.create(title: "You pass a friendly old woman in the park", description: "She offers you a portion of her lunch. What luck!", hazard_rating: 0, lives_score: 0, hunger_score: - 1, scraggliness_score: 0, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2013/07/12/18/39/grandmother-153657_1280.png")

n3c1 = Event.create(title: "A prissy stray cat catches you unawares!", description: "They get the better of you, and you slink away in shame.", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: 0, cred_score: - 1, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2017/06/15/06/28/cat-2404287_1280.png")

n3c2 = Event.create(title: "You sneak up on a prissy stray cat. Show them who's Top Cat around here!", description: "They flee in terror! The local neighborhood cats will remember this.", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: 0, cred_score: + 2, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2017/06/15/06/28/cat-2404287_1280.png")
...
n4e3 = Event.create(title: "You find a mouse and begin to chase it!", description: "A well earned lunch. Nature can be cruel, but everyone has to eat.", hazard_rating: 0, lives_score: 0, hunger_score: - 1, scraggliness_score: 0, cred_score: 0, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2016/04/01/12/20/animal-1300671__480.png")

n4c1 = Event.create(title: "A filthy stray cat catches you unawares!", description: "They get the better of you, and you slink away in shame.", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: + 1, cred_score: - 1, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2012/05/07/04/05/cat-47896__480.png")

n4c2 = Event.create(title: "You sneak up on a filthy stray cat. Show them who's Top Cat around here!", description: "They flee in terror! The local neighborhood cats will remember this.", hazard_rating: 0, lives_score: 0, hunger_score: 0, scraggliness_score: 0, cred_score: + 2, posh_event: false, img_url: "https://cdn.pixabay.com/photo/2012/05/07/04/05/cat-47896__480.png")
